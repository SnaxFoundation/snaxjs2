...
describe("snaxjs-api", () => {
    ...
    it("getAbi returns an abi", async () => {
        const response = await api.getAbi("testsnaxtoken");
    ...
    it("getContract returns a contract", async () => {
        const response = await api.getContract("testsnaxtoken");
